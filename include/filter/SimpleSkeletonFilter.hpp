...
template <typename Value>
class SimpleSkeletonFilterBuilder : public AbstractSkeletonFilterBuilder<Value> {
    int joint_count;
...
public:
    SimpleSkeletonFilterBuilder(int m_joint_count,
    ...
    {
        return std::make_shared<SimpleSkeletonFilter<Value>>(measurement_noises, system_noises, joint_count, m_factor,
