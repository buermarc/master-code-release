...
public:
    ...
    AdaptiveZarchanFilter1D(MatrixXd ad, MatrixXd c, MatrixXd gd,
        Value m_measurement_noise, Value m_system_noise,
        Value m_threshold, Value m_system_scale_factor,
        int m_std_scale,
